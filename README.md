...
- D1 schema and tested quiz state/storage contracts. Twelve automated application tests.
...
Checks: `npm run typecheck`, `npm test`, `npm run research:check`, `node scripts/validate-content.mjs`.
Build: `npm run build`.
