...
const plan = JSON.parse(fs.readFileSync('research/batches/2026-09-08-cross-subject-lower-01.plan.json', 'utf8'));
const ledger = JSON.parse(fs.readFileSync('research/paper-ledger.json', 'utf8'));
...
console.log(JSON.stringify({plan: plan.batchId, valid: true, pairs: plan.pairs.length, obtained: 0, indexed: 0, processed: 0, astraFilesChanged: false}, null, 2));
